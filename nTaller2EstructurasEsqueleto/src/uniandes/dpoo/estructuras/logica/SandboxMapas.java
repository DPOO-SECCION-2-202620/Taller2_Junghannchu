...
public class SandboxMapas
{
    ...
    public Collection<String> getLlaves( )
    {
        ...
        for( String llave : mapaCadenas.keySet( ) ) llaves.add( llave.toUpperCase( ) );
        return llaves;
    }
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        {
            if( entrada.getValue( ).equals( valor ) ) { llave = entrada.getKey( ); break; }
        }
        if( llave != null ) mapaCadenas.remove( llave );
    }
    ...
    {
        mapaCadenas.clear( );
        for( Object objeto : objetos ) agregarCadena( objeto.toString( ) );
    }
    ...
    public boolean compararValores( String[] otroArreglo )
    {
        ...
        for( String cadena : otroArreglo ) if( !mapaCadenas.containsValue( cadena ) ) return false;
        return true;
    }
