...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        {
            if( actual.equalsIgnoreCase( cadena ) ) { encontrada = actual; break; }
        }
    ...
    {
        arbolCadenas.clear( );
        for( Object objeto : objetos ) arbolCadenas.add( objeto.toString( ) );
    }
    ...
    public void volverMayusculas( )
    {
        ...
        for( String cadena : arbolCadenas ) mayusculas.add( cadena.toUpperCase( ) );
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        for( String cadena : otroArreglo ) if( !arbolCadenas.contains( cadena ) ) return false;
        return true;
    }
